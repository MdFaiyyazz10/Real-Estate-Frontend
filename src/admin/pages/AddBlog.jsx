            ...
            <div className='add-blog-container1'>
                <h4 className='m-3 add-blog'>Add Blog </h4>            
                    ...
                    <div className='add-blog-sec-content'>
                        <h5 className='add-'>Blog Name</h5><br />
                        ...
                        <input className='add-blog-inpu-name-des' type="text" onChange={changeHandler} id='content' /><br />
                        <button className='add-blog-sec-button'>Add</button>
