                            ...
                            <form onSubmit={registerSubmitHandler}>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <input placeholder='Enter Email Address:' type="email" name='email' required onChange={registerChangeHandler} />
                                    </div>
                                    <div>
                                        <label htmlFor="">Phone Number :</label>
                                        <input placeholder='Enter Phone No:' type="number" name='phone' required onChange={registerChangeHandler} />
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <input placeholder='Enter Password:' type="password" name='password' required onChange={registerChangeHandler} />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <input placeholder='Enter Adhar Number:' type="email" required />
                                    </div>
                                    <div>
                                        <label htmlFor="">Pan Number :</label>
                                        <input placeholder='Enter Pan Number:' type="number" required />
                                    </div>
                                </div>
